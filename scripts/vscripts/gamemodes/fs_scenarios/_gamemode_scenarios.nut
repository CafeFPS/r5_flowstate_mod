...
global function AddToTrackedEnts_RefScenarios
global function DropLoot_RefScenarios
...
void function AddToTrackedEnts_RefScenarios( entity player, entity ent )
{
	scenariosGroupStruct ornull group = FS_Scenarios_ReturnGroupForPlayer(player)
...
void function DropLoot_RefScenarios( entity player )
{
	scenariosGroupStruct ornull group = FS_Scenarios_ReturnGroupForPlayer(player)
