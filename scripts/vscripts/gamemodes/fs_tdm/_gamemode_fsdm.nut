...
void function FS_GiveRandomMelee(entity player, bool is1v1 = false )
{
	...
	Heirloom randomMelee = CreateHeirloom( "melee_pilot_emptyhanded", "mp_weapon_melee_survival" ) //GetCommunityHeirlooms().getrandom() //todo(cafe): allow players to choose heirloom? possibly a new menu for "cosmetics" where players can choose the heirloom and camo color with persistence
